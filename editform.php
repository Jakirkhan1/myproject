...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="edform" action="editform.php" method="post">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <img src="images/adminlogin.png" width="89%" style="box-shadow: 1px 5px 14px #999999; "></img>
                </div>
            </div>
        </div>
        ...
        <table class="frmtbl">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td colspan="3"> <input type="text" id="uphn1" name="uphn1" value="<?php echo $uphn1  ?>">
                        <input type="text" id="uphn2" name="uphn2" value="<?php echo $uphn2  ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" id="ufphn" name="ufphn" value="<?php echo $ufphn ?>"> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" id="umphn" name="umphn" value="<?php echo $umphn ?>"></td>
                </tr>
