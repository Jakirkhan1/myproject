    ...
    <body style="background-image:url('./images/inbg.jpg');">
        <form id="docup" enctype="multipart/form-data" name="docup" action="documents.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/smiulms.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="table table-striped">
                            ...
                            <tr>
                                 ...
                                 <td><input type="file" id="fpic" name="fpic" ><br></td>
                            </tr> 
            ...
            <div class="container">
              <center> 
                <div class="jumbotron" style="width:100%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                    ...
                    <p>
                        <font style=" font-family: Verdana;font-size:medium">
                    ...
                    <font>
                        <input type="checkbox" id="dec" name="dec" value="I accept" onclick="send()"><font style=" font-family: Verdana;    
                        font-size:medium">
                        I accept
                    </font>
