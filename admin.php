...
<body>
    ...
    <form id="admin" action="admin.php" method="post">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <img src="images/adminlogin.png" width="100%" style="box-shadow: 0px 5px 5px #999999; "></img>
                </div>
            </div>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="container">
                                    <center>
                                        <div class="jumbotron" style="width:50%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                                            <div class="row">
                                                <div class="col-sm-6">

                                                    <input type="text" name="omarkof" id="search1" class="form-control" placeholder="Application 
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="searhid1" value="<?php echo $usname ?>" class="form-control" 
                                                     style="width:200px;" /><br/>
                                                    <input type="text" name="txtomr" placeholder="Enter OMR No." class="form-control" 
                                                     style="width:200px;" />
                                        ...
                                        <div class="jumbotron" style="width:50%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="markof" id="search2" class="form-control" placeholder="Application ID" 
                                                     style="width:200px;" />
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="showomr" id="showomr" placeholder="Omr" class="form-control" 
                                                     style="width:200px;" /><br>
                                                    <input type="text" name="txtmark" placeholder="Enter Marks" class="form-control" 
                                                     style="width:200px;" />
                ...
                <div id="adadmin" class="tab-pane fade">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" id="txtname" name="txtname" class="form-control" style="width:200px;margin-left:32px;" 
                             placeholder="Name"><br><br>
                            <input type="text" id="txteml" name="txteml" class="form-control" style="width:200px;margin-left:32px;" 
