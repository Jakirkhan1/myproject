                                ...
                                <div class="col-sm-12">
                                    <center>
                                        <table class="table table-bordered" style="font-family: Verdana">
                                            ...
                                            <tr>
                                                <td style="width:3%;"><img src="./images/logo.png" width="90%"> </td>
                                                <td style="width:8%;">
                                                    <center>
                                    ...
                                    <center>
                                        <font style="font-family:Verdana; font-size:18px;">
                                            Phone : 01756666666, Fax : (0256)662594
                                        </font>
                                    </center>
                                    ...
                                    <tr>
                                        <td>
                                            <font style="font-family: Verdana;">ID : </font>
                                        </td>
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <font style="font-family: Verdana; font-size:15px;"> 1) Application Status
                                                    <p align="right"> <?php echo $stval ?></p>
                                                </font>
                                            </li>
                                            <li class="list-group-item">
                                            ...
                                            <li class="list-group-item">
                                                <font style="font-family: Verdana; font-size:15px;"> 4) Payment</font>
                                                <p align="right" style="font-family: Verdana; font-size:15px;">
                                                    <a href="">Click Here</a>
                                                </p>
                                            </li>
                                            <li class="list-group-item">
                                                <font style="font-family: Verdana; font-size:15px;"> 5) Print Admit Card</font>
                                                <p align="right" style="font-family: Verdana; font-size:15px;">
