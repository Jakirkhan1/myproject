...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="signupconfirm" action="signupconfirm.php" method="post">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <a href="index.php"><img src="images/smiulms.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img></a>
                </div>
            </div>
        </div>
        <div id="dmid">
        ...
        <div id="ddown">
            ...
            <div id="dleft">
                ...
                <a href="login.php"><img src="images/signup1.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;"></img></a>
            </div>
            <div id="drig">
                <br><br><br><br><br>
                <center>
                    <font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:20px;">
                        ...
                        You are successfully registered. Please check your email ID or Phone for User ID and Password. </font>
                </center>
                <br><br>

                <input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary" style="width:100px; margin-left: 200px;"><br><br><br>
            </div>
        </div>
