...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="adform" action="admsnform.php" method="post">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <a href="index.php"><img src="images/smiulms.png" width="89%" style="box-shadow: 1px 5px 14px #999999; "></img></a>
                </div>
            </div>
        </div>
        ...
        <table class="frmtbl">
            ...
            <tr>
                <td>
                    <font style="font-family: Verdana;">
                        <h4>Welcome To BAUET, <?php echo $stname; ?></h4>
                    </font>
                </td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td colspan="3"> <input type="text" id="uphn1" name="uphn1" placeholder="Telephone" required="true" VT="PH">
                    <input type="text" id="uphn2" name="uphn2" placeholder="Mobile Number" required="true" VT="PH">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="radio" id="gen" name="gen" value="Male">
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="cadr" name="cadr" class="ad" placeholder="Country" required="true"><br>
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="padr" name="padr" class="ad" placeholder="Country" required="true"><br>
            ...
            <tr>
                <td colspan="4"><input type="radio" id="rur" name="rur" value="Rural">
                    <font style="font-family: Verdana;">
                        Rural
                        <input type="radio" id="rur" name="rur" value="Urban">
                        <font style="font-family: Verdana;">Urban</font>
                        <input type="radio" id="rur" name="rur" value="City">
                        <font style="font-family: Verdana;">City</font>
                </td>
            </tr>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <font style="font-family: Verdana;font-size: small">Board</font>
                                </th>
                                <th>
            ...
            <tr>
                <td colspan="4">
                    <center>
                        <input type="submit" onclick="validate();" id="frmnext" name="frmnext" value="Next">
                    </center>
                </td>
            </tr>
